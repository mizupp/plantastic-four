...
<input type="text" className="form-control mb-2" placeholder="Add a food!" ></input>
          ...
          <div className="" style={{justifyContent: 'center'}}>
            <form onSubmit={submitFormData} method="POST" encType="multipart/form-data">
              <div className="form-group text-center">
                <label htmlFor="exampleFormControlFile1"><b>Input a file</b></label>
                <input type="file" name="file" className="form-control-file" id="inputImage" onChange={(e) => setData(e.target.value)} required />
                <br />
